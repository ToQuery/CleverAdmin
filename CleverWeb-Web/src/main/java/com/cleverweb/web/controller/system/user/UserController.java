...
import com.cleverweb.common.util.FileUpload;
import com.cleverweb.common.util.GetPinyin;
import com.cleverweb.core.utils.Jurisdiction;
import com.cleverweb.common.util.ObjectExcelRead;
import com.cleverweb.common.util.ObjectExcelView;
...
public class UserController extends BaseController {
	...
	public ModelAndView listUsers(Page<TbSysUser> page)throws Exception{
		ModelAndView mv = new ModelAndView();

		Page<TbSysUser>	userList = sysUserService.findListByPage(page);	//列出用户列表
		Page<Role> roleList = sysRoleService.findListByPage(page);//列出所有系统用户角色
