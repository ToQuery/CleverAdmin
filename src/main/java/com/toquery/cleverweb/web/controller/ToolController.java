...
import com.toquery.cleverweb.common.util.DelAllFile;
import com.toquery.cleverweb.common.util.FileDownload;
import com.toquery.cleverweb.common.util.Freemarker;
import com.toquery.cleverweb.common.util.MapDistance;
...
public class ToolController extends BaseController {
    ...
    public Object createTwoDimensionCode() {
        Map<String, String> map = new HashMap<String, String>();
        PageData pd = new PageData();
        String errInfo = "success", encoderImgId = UuidUtil.get32UUID() + ".png"; //encoderImgId此处二维码的图片名
